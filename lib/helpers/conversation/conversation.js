...
export const sendMessage = async (
	...
	try {
		const updatedConversation = await requestPostNewMessage(conversationId, message)
		// dispatch message sent
		if(updatedConversation){
			return dispatch(Actions.setConversation(updatedConversation), Actions.messageSent())
